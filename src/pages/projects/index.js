  ...
  <div>
    ...
    <OrderList>
      ...
      <li>
        Transit Bot:
        <p>
          This is a prototype for accessing Slack and also MTA packages. I have used Node since I wanted to learn a new language. From this prototype, I will just take the MTA API calls and add them to Lambda. 
        </p> 
      </li>
      <li>
